...
> **Build log — keep this current.** Marketing version `1.0`. Highest build uploaded to TestFlight: **5**. Committed and ready to upload next: **6**. Before each upload, set this to the next unused integer (here *and* in the project), then update this line after uploading.
